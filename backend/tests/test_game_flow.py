...
from backend.app.models import BoardLinkRequest, CaseBriefInput, RescanRequest, SearchRequest, SubmitTheoryRequest
...
class GameFlowTests(unittest.TestCase):
    ...
    def test_board_link_unlocks_hidden_suspect_with_document_node_id(self) -> None:
        response = self.game.add_board_link(
            "case-001",
            self.alias,
            BoardLinkRequest(
